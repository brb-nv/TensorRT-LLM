...
HND view contract passed to the packaged MSA kernel; the CUDA-gated tests cover
the fused cache-scatter parity and strided-cache kernel paths. Numerical parity
against the Triton reference is covered by the SM100 integration accuracy test.
"""
