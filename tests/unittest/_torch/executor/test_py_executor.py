...
def _run_sync_idle_progress_rank(rank: int, world_size: int, rendezvous_file: str) -> None:
    ...
    try:
        ...
        PyExecutor._check_disagg_transfer_progress_when_idle(executor, is_idle=True)
    finally:
...
class TestDisaggTransferIdleProgress:
    ...
    def test_gen_only_no_context_benchmark_skips_context_poll_when_idle(
