...
def get_test_config(test_desc, example_dir, test_root):
    ...
    config_map = {
        ...
        "deepseek_v3_lite_fp8_tllm_gen_120k":
        (4,
         f"{test_configs_root}/disagg_config_ctxtp2_gentp2_deepseek_v3_lite_fp8_tllm_gen_128k.yaml"
         ),
...
@pytest.mark.parametrize("deepseek_v3_model_root", ['DeepSeek-V3-Lite-fp8'],
                         indirect=True)
def test_disaggregated_deepseek_v3_lite_fp8_tllm_gen_120k(
        disaggregated_test_root, disaggregated_example_root, llm_venv,
        deepseek_v3_model_root):
    src_dst_dict = {
        deepseek_v3_model_root:
