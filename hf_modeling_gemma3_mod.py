...
class Gemma3ForCausalLM(Gemma3PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        # (Pdb) outputs['last_hidden_state'].shape
        # torch.Size([1, 13, 1152])
        # (Pdb) len(outputs['hidden_states'])
        # 27
        # (Pdb) outputs['hidden_states'][0].shape
        # torch.Size([1, 13, 1152])
        # (Pdb) len(outputs['attentions'])
        # 26
        # (Pdb) outputs['attentions'][0].shape
