...
{
    m.impl("helixAllToAll", &helixAllToAll);
    m.impl("getHelixWorkspaceSizePerRank", &getHelixWorkspaceSizePerRank);
    m.impl("initializeHelixWorkspace", &initializeHelixWorkspace);
}
