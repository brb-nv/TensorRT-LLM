...
def select_blocks_from_maxscore(
    ...
    *,
    ...
    with nvtx_range_debug("select_blocks.scores_clone", color="red"):
    ...
    with nvtx_range_debug("select_blocks.mask", color="magenta"):
        if init_blocks > 0:
    ...
    with nvtx_range_debug("select_blocks.topk_sort", color="blue"):
        k = min(topk, n_blocks)
